...
b_letter = text(3,0.23,'B','Color','black','FontSize',40);
c_letter = text(40,0.27,'C','Color','black','FontSize',40);
d_letter = text(40,0.45,'D','Color','black','FontSize',40);
%delete(a_letter); delete(b_letter); delete(c_letter); delete(d_letter);

%a_text = text(1.1,0.4,'generalists','Color','blue','FontSize',18);
a_text = text(1.5,0.4,'generalists','Color','blue','FontSize',18);
b_text1 = text(1.8,0.18,'generalists &','Color','blue','FontSize',18);
b_text2 = text(1.8,0.15,'common specialists','Color',[0 0.5 0],'FontSize',18);
c_text = text(33,0.20,['common' newline 'specialists'],'Color',[0 0.5 0],'FontSize',18);
d_text1 = text(30,0.40,'common &','Color',[0 0.5 0],'FontSize',18);
d_text2 = text(30,0.37,['rare ' 'specialists'],'Color',[0.7 0 0],'FontSize',18);
