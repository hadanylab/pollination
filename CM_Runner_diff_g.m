...
D_arr=[linspace(1,9.5,50) logspace(1,2,50)];

%D_arr=[logspace(0,2,5)];
%
...
%p2_next_arr=[];
p2_crit_big_arr = zeros(length(b2_arr),length(D_arr));
p2_next_big_arr = zeros(length(b2_arr),length(D_arr));
seed_set1_big_arr = zeros(length(b2_arr),length(D_arr));
seed_set2_big_arr = zeros(length(b2_arr),length(D_arr));
poll_fitness1_big_arr = zeros(length(b2_arr),length(D_arr));
poll_fitness2_big_arr = zeros(length(b2_arr),length(D_arr));
poll_fitness3_big_arr = zeros(length(b2_arr),length(D_arr));
p2_no_morph_big_arr = zeros(length(b2_arr),length(D_arr));
